...
import info.sayederfanarefin.hello.api.GreetingMessage;
import info.sayederfanarefin.hello.api.HelloService;
import info.sayederfanarefin.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
    ...
    @Override
    public Topic<info.sayederfanarefin.hello.api.HelloEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    info.sayederfanarefin.hello.api.HelloEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new info.sayederfanarefin.hello.api.HelloEvent.GreetingMessageChanged(
